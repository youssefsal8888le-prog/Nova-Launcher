...
import net.kdt.novalaunch.contracts.OpenDocumentWithExtension;
...
import net.kdt.novalaunch.fragments.MainMenuFragment;
import net.kdt.novalaunch.fragments.MicrosoftLoginFragment;
import net.kdt.novalaunch.fragments.SelectAuthFragment;
import net.kdt.novalaunch.lifecycle.ContextAwareDoneListener;
import net.kdt.novalaunch.lifecycle.ContextExecutor;
import net.kdt.novalaunch.modloaders.modpacks.ModloaderInstallTracker;
import net.kdt.novalaunch.modloaders.modpacks.imagecache.IconCacheJanitor;
import net.kdt.novalaunch.prefs.LauncherPreferences;
import net.kdt.novalaunch.prefs.screens.LauncherPreferenceFragment;
import net.kdt.novalaunch.progresskeeper.ProgressKeeper;
import net.kdt.novalaunch.progresskeeper.TaskCountListener;
import net.kdt.novalaunch.services.ProgressServiceKeeper;
import net.kdt.novalaunch.tasks.AsyncMinecraftDownloader;
import net.kdt.novalaunch.tasks.AsyncVersionList;
