package net.kdt.novalaunch.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("net.kdt.novalaunch.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
